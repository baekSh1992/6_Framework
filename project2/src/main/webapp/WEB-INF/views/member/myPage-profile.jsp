...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%> <%-- 코어테그 라이브러리--%>
...
<%-- 
                ...
                <%-- 
                    ...
                    1) application/x-www-form-urlencoded (기본값) // 엔크타입
                ...
                name="myPage-frm" entype="multipart/form-data"
                onsubmit="return profileValidate()">

                    <div class="profile-image-area">
                        
                        <c:if test="${empty loginMember.profileImage}">
                            <img id="profile-image" src="/resources/images/user2.png">
                        </c:if>
